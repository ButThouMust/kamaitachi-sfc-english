...
; get Tooru's name into $28-$35
    pha
    ldy #$0000
    jsr WriteNameFromScratchpadIntoDirectPageForFileSelect
...
WriteNameFromScratchpadIntoDirectPageForFileSelect:
    php
...
; fill top byte of A with 00, then use M=1
    txa
    sep #$20
...
; this code is almost the exact same, but I need to get more ROM space for the
; one-byte text encoding hack for the names on the bookmarks
; solution: $028000 backs up X/Y when you call it, and this sub leaves both alone
ConvertHexValInAToBCD:
    phd
    cop #$07
    db $03,$00,$00,$00
    dl $000000
...
-   inx #2
    lda $02,x
    bmi GotWidthOfTextForCenteredPosCalculation
